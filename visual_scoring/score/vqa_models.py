...
vqa_models = {
    ...
    "mplug-large": ("MPLUG", "/root/autodl-tmp/models/iic/mplug_visual-question-answering_coco_large_en/"),
...
class MPLUG:
    def __init__(self, ckpt='damo/mplug_visual-question-answering_coco_large_en', device="cuda:1"):
...
class VQAModel:
    def __init__(self, model_name='mplug-large', device="cuda:1"):
        print(f"Loading {model_name}...")
        self.model_name = model_name
        class_name, ckpt = vqa_models[model_name]
        self.model = eval(class_name)(ckpt, device)
